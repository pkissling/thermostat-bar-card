...
customElements.define('action-handler-thermostat-bar-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-thermostat-bar-card')) {
    return body.querySelector('action-handler-thermostat-bar-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-thermostat-bar-card');
